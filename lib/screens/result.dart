...
import 'package:plant_disease_detection/utilities/disease_info.dart';
...
class Info extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   page.graphics.drawImage(PdfBitmap(await _readImageData(imagePath)),
    Rect.fromLTRB(140, 0, 400, 200));


// Create a new PDF documen
// Create a new PDF text element class and draw the flow layout text.
//1

page.graphics.drawString('Cause of Disease', 
...
// Create a new PDF text element class and draw the flow layout text.
//2
page.graphics.drawString('Symptoms', 
PdfStandardFont(PdfFontFamily.helvetica, 25),
bounds: Rect.fromLTWH(
            0, layoutResult.bounds.bottom + 10 , page.getClientSize().width, page.getClientSize().height)
);
final PdfLayoutResult layoutResult2 = PdfTextElement(
    ...
    .draw(
        page: page,
        bounds: Rect.fromLTWH(
            0, layoutResult.bounds.bottom + 40 , page.getClientSize().width, page.getClientSize().height),
        format: PdfLayoutFormat(layoutType: PdfLayoutType.paginate))!;
...
page.graphics.drawString('Cure of disease', 
PdfStandardFont(PdfFontFamily.helvetica, 25),
bounds: Rect.fromLTWH(
            0, layoutResult2.bounds.bottom + 10 , page.getClientSize().width, page.getClientSize().height)
);
final PdfLayoutResult layoutResult3 = PdfTextElement(
    ...
    .draw(
        page: page,
        bounds: Rect.fromLTWH(
            0, layoutResult2.bounds.bottom + 40 , page.getClientSize().width, page.getClientSize().height),
        format: PdfLayoutFormat(layoutType: PdfLayoutType.paginate))!;
